  ...
  return (
    ...
    <div>
      ...
      >
        <li className="pull-left header">
          ...
          <strong>
            <h3><strong><i className="fa fa-inbox"></i>Make II Project OFB List</strong></h3>
          </strong>
          {/* <hr/> */}
        </li>
      </ul>
    ...
    <div>
      <header className="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-Top text-center">
        ...
        <Link to="/admin/index/addmakeproject2dpsu" className="btn btn-info"  ><i className="fa fa-user-plus" aria-hidden="true"></i>Add Data</Link>
        </div>
      </header>
      ...
      <div className="table -responsive ">
        <table className="table table-responsive table-striped table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              <td colspan="5" style= {{textAlign:"center"}}>  No data avilabe in table</td>
...
export default Makeproject2dapsu